...
classdef REAL_EXPERIMENT < handle
   properties     
       % image parameters
       sl_em
       sl_ex 
   ...
   methods
       % constructor
       function obj = REAL_EXPERIMENT(parameterFile)
           ...
           obj.Y        = MEASURE_IMAGESTACK([],dataPath,dataNameStem,Nx/nx,Ny/ny,Nt_mx,EmGain,crop_rect_name);
