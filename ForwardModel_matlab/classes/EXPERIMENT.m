...
classdef EXPERIMENT < handle
   ...
   methods
       % constructor
       function obj = EXPERIMENT(parameterFile,Nt)
           run(parameterFile);
                      
           obj.Ex = CALIB_IMAGESTACK([],extPath,extNameStem,Nx,Ny,Nt,EmGain,crop_rect_name_ex); 
           obj.Y = MEASURE_IMAGESTACK([],dataPath,dataNameStem,Nx,Ny,Nt,EmGain,crop_rect_name);
